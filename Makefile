# This Makefile is for the Parse::Yapp extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     EXE_FILES => [q[yapp]]
#     MAN3PODS => { lib/Parse/Yapp.pm=>q[$(INST_MAN3DIR)/Parse::Yapp.3] }
#     NAME => q[Parse::Yapp]
#     PM => { lib/Parse/Yapp.pm=>q[$(INST_LIBDIR)/Yapp.pm], lib/Parse/Yapp/Driver.pm=>q[$(INST_LIBDIR)/Yapp/Driver.pm], lib/Parse/Yapp/Grammar.pm=>q[$(INST_LIBDIR)/Yapp/Grammar.pm], lib/Parse/Yapp/Lalr.pm=>q[$(INST_LIBDIR)/Yapp/Lalr.pm], lib/Parse/Yapp/Options.pm=>q[$(INST_LIBDIR)/Yapp/Options.pm], lib/Parse/Yapp/Output.pm=>q[$(INST_LIBDIR)/Yapp/Output.pm], lib/Parse/Yapp/Parse.pm=>q[$(INST_LIBDIR)/Yapp/Parse.pm] }
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Parse/Yapp/Driver.pm]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/wbraswell/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/wbraswell/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.24
MM_REVISION = 72400
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) -u \
	  yapp $(INST_MAN1DIR)/yapp.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Parse/Yapp.pm $(INST_MAN3DIR)/Parse::Yapp.3 
...
$(INST_SCRIPT)/yapp : yapp $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/yapp
	$(CP) yapp $(INST_SCRIPT)/yapp
	$(FIXIN) $(INST_SCRIPT)/yapp
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/yapp
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Parse-Yapp' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Parse-Yapp",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-gnu-thread-multi-5.22" />' >> Parse-Yapp.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> Parse-Yapp.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Parse-Yapp.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Parse-Yapp.ppd
